...
# KM-07: Trusler og trusselbilde / Threats and Threat Landscape

## 🎯 Mål / Competency Goal

***Norsk:**Utforske trusler mot datasikkerhet og gjøre rede for dagens trusselbilde og hvordan truslene kan påvirke en
*åpen samfunnsdebatt og tilliten til demokratiet

***English:**Explore threats to data security and explain the current threat landscape and how threats can affect open
*public debate and trust in democracy
...
TTrusselbildet innen datasikkerhet endrer seg raskt. En trussel er alt som kan utnytte en sårbarhet til å skade et system
Teller stjele data[^1][^5]. De viktigste truslene i dag inkluderer:
...
PPåvirkningen på demokratiet er alvorlig: når folk ikke vet hva de kan stole på, svekkes tilliten til medier, politikere
Pog institusjoner[^2].

### English

TThe security threat landscape changes rapidly. A threat is anything that can exploit a vulnerability to damage a system
Tor steal data[^1]. Today's key threats include:
...
TThe impact on democracy is serious: when people don't know what to trust, trust in media, politicians, and institutions
Tis weakened[^2].
...
*## Eksempel 1: Ransomware-angrep på skole
EEn skole blir rammet av ransomware. Alle filer blir kryptert. Elevene mister oppgavene sine, og skolen må betale
Eløsepenger eller gjenopprette fra backup.

*## Eksempel 2: Påvirkningsoperasjon
FFør et valg spres falske nyheter på sosiale medier om at stemsystemet er manipulert.
FMange mister tilliten til valgresultatet — selv om påstanden er feil.

### English (2)

*## Example 1: Ransomware Attack on a School
AA school is hit by ransomware. All files are encrypted. Students lose their assignments, and the school must either pay
Athe ransom or restore from backup.

*## Example 2: Influence Operation
BBefore an election, fake news spreads on social media claiming the voting system is rigged.
BMany people lose trust in the election result — even though the claim is false.
...
|| Norsk | English |
|| ------- | --------- |
|| Trusler kan være tekniske (malware) eller samfunnsrettede (desinformasjon) | Threats can be technical (malware) or societal (disinformation) |
|| Ransomware og phishing er de vanligste angrepene | Ransomware and phishing are the most common attacks |
|| Desinformasjon truer den åpne samfunnsdebatten | Disinformation threatens open public debate |
|| God sikkerhetsforståelse beskytter både data og demokrati | Good security understanding protects both data and democracy |
...
4. "Pakken din er klar for henting" — med lenke og hasteordlyd
5. "Vennligst se vedlagt faktura" — fra en kjent leverandør, men e-post-adressen er feil
6. "IT-avdelingen ber deg oppdatere passordet" — med lenke til en logginn-side
- Er dette phishing? Hvorfor / hvorfor ikke? Hvilke ledetråder ser du?
- Lag en sjekkliste: "5 tegn på phishing"

*## Oppgave 2: Research og presentasjon av aktuell trussel
EEleven velger én aktuell sikkerhetstrussel fra nyhetene (siste 12 måneder). Research: Hvordan fungerte angrepet? Hvem
Esto bak? Konsekvenser? Hvordan kunne det vært forhindret?
...
*## Exercise 1: Identify Phishing Emails
SStudents receive 6 sample emails. For each: Is this phishing? Why / why not? What clues do you see? Create a checklist:
S"5 signs of phishing".

*## Exercise 2: Research and Present a Current Threat
CChoose one recent security threat from the news (last 12 months). How did the attack work? Who was behind it?
CConsequences? How could it have been prevented?
...
- [[trusselbildet]] — Det nåværende trusselbildet og viktige trusler
- [[risikoanalyse]] — Hvordan gjennomføre risikoanalyse (KM-08)
