...
**Q:** The _____ layer of the OSI model handles MAC addresses and organizes bits into frames.
...
**Q:** The _____ layer of the OSI model ensures end-to-end communication, flow control, and error recovery using protocols like TCP.
...
**Q:** The _____ layer handles data formatting, encryption, and compression to make data presentable for the application layer.
...
**Q:** The process of adding a header to data as it moves down the OSI layers is called _____.
...
**Q:** VLANs operate at Layer _____ of the OSI model.
...
**Q:** A _____ is a portion of a larger network that has been isolated to improve security or performance.
