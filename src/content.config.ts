...
const emner = defineCollection({
  ...
  schema: z.object({
    ...
    flashcards: z.union([z.boolean(), z.string()]).nullable().optional().default(false),
    notebooklm: z.union([z.boolean(), z.string()]).nullable().optional().default(false),
    podcast: z.union([z.boolean(), z.string()]).nullable().optional().default(false),
    video: z.union([z.boolean(), z.string()]).nullable().optional().default(false),
    quiz: z.union([z.boolean(), z.string()]).nullable().optional().default(false),
    infographic: z.union([z.boolean(), z.string()]).nullable().optional().default(false),
